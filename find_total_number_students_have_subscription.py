...
"""
# Input number of students subscribed to the English newspaper
n_english = int(input())
english_students = set(map(int, input().split()))

# Input number of students subscribed to the French newspaper
n_french = int(input())
french_students = set(map(int, input().split()))

# Find the union of both sets
total_students = english_students.union(french_students)
